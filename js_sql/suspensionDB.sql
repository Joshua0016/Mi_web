...
-- modelosaños
insert into modelos_años (modelo_id, año) value (1, "1986-1995");
insert into modelos_años(modelo_id, año) value (1, "1886-1888"); 
insert into modelos_años(modelo_id, año) value (1, "1989-1995");
insert into modelos_años(modelo_id, año) value (1, "1996-2002");
insert into modelos_años(modelo_id, año)
	value
		(1, "2003-2019"),
        (1, "2010-2019");
select * from modelos_años;       
select modelos_años.año, marcas.modelo from modelos_años left join marcas on modelos_años.modelo_id = marcas.id;        
insert into modelos_años(modelo_id, año) value (2, "2001-2006"); 
insert into modelos_años(modelo_id, año)	value (2, "2007-20017");

insert into modelos_años(modelo_id, año) values (3, "1996-2008");
insert into modelos_años (modelo_id, año)
	values
		(3, "2009-2019");
insert into modelos_años (modelo_id, año) values (4, "2001-2007");
insert into modelos_años (modelo_id, año) values	
	(5,"1996-2002"),
    (5,"2003-2008");
insert into modelos_años (modelo_id, año) 
		values
...
insert into modelos_años (modelo_id, año) values (11, "1995-1998");        
insert into modelos_años(modelo_id, año ) values (11, "1999-2003");   
insert into modelos_años(modelo_id, año) values (12, "2003-2008");
...
insert into balljoints (añoID, refJointInf) values(3, "43330-39265");
...
insert into balljoints (añoID,  refJointInf_izq, refJointInf_der) value (7, "43340-29175", "43330-29405");
...
insert into balljoints (añoID, refjointInf)
	values
		(9, "43330-19115"),
		(10, "43330-09190");
insert into balljoints (añoID, refJointInf_izq, refJointInf_der) value (11, "43340-29175","43330-29405");        
insert into balljoints (añoID, refJointInf_izq, refJointInf_der) value(12, "43340-39465", "43330-39585");
insert into balljoints (añoID, refJointInf) values (13, "43330-60010");
insert into balljoints (añoID, refJointInf)
	values
		(14, "43330-19115"),
		(15, "43330-49095");
...
insert into balljoints (añoID, refJointInf_izq, refJointInf_der) values (22, "51230-SNA-A03","51220-SNA-A03");
insert into balljoints (añoID, refJointInf) values (23, "51220-TR0-A01");            
 insert into balljoints (añoID, refJointInf, refJointSup)
	values
...
insert into balljoints (añoID, refJointInf)
			values	
				(27, "51220-SEL-T01"),
                (28, "51220-TK6-A01");
insert into balljoints (añoID, refJointInf) values (29, "51220-SM1-A02");
insert into balljoints (añoID, refJointInf) values (30, "51220-S0X-A01");
insert into balljoints (añoID, refJointInf) values (31, "51220-S3V-A01");
